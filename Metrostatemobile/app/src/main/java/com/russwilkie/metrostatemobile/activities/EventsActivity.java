...
public class EventsActivity extends AppCompatActivity {
    ...
    private void getData(){
        StringRequest stringRequest = new StringRequest(Config.EVENTS_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONListAdapter adapter= new JSONListAdapter(EventsActivity.this, R.layout.json_listview, R.id.txtheader,listItems);
